...
const StatusTabs: React.FC = () => {
  ...
  return (
    <div className="fixed top-40 left-0 right-0 flex flex-col items-center z-30 h-[calc(100vh-160px)]">
      ...
      {articles.length > ITEMS_PER_PAGE && (
        <div className="fixed bottom-0 left-0 right-0 flex justify-center bg-white/80 backdrop-blur-sm py-4 shadow-lg">
          <Pagination
